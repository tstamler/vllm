...
RESULT_DIR="${RESULT_DIR:-$VLLM_ROOT/bench-results-ft-communicator-ep-${DP}gpu}"
READY_CHECK_TIMEOUT_SEC="${READY_CHECK_TIMEOUT_SEC:-1800}"
RUN_ID="${RUN_ID:-$(date +%Y%m%d-%H%M%S)}"
BENCH_EXTRA_ARGS="${BENCH_EXTRA_ARGS:-}"

DEFAULT_FT_COLLECTIVE_PYTHON="/Users/tstamler/nccl/contrib/fault_tolerant_collectives"
DEFAULT_FT_COLLECTIVE_PYTHON+="/ft_handle/python"
FT_COLLECTIVE_PYTHON="${FT_COLLECTIVE_PYTHON:-$DEFAULT_FT_COLLECTIVE_PYTHON}"
FT_NCCL_MAX_COUNT="${FT_NCCL_MAX_COUNT:-33554432}"
