...
state, and a CSV of median throughput and FT overhead. The curated branch keeps
one latest reference repetition under
`examples/fault_tolerance/ft_nccl_ep/results/no_failure/`.
